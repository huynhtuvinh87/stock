...
<head>
    ...
    <style>
        .index-header {
            background-image: url('{{ url('img', $settings->image_header) }}')
        }

        .jumbotron-bottom {
            background-image: url('{{ url('img', $settings->image_bottom) }}')
        }

        .header-colors {
            background-image: url('{{ url('img', $settings->header_colors) }}')
        }

        .header-cameras {
            background-image: url('{{ url('img', $settings->header_cameras) }}')
        }
    </style>
