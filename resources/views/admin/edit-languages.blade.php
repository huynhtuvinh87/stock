      ...
      <div class="content-wrapper">
        ...
        <section class="content">
        	...
        	<div class="box box-danger">
                ...
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{ url('panel/admin/languages/edit',$data->id) }}">
                 ...
                 <!-- Start Box Body -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{ $data->abbreviation }}" name="abbreviation" class="form-control" placeholder="{{ trans('admin.abbreviation') }}">
