              ...
              <div class="box">
               ...
               <tbody>
                  ...
                  @foreach( $data as $image )
                   ...
                   <a href="{{ url('panel/admin/images', $image->id) }}" class="btn btn-success btn-sm padding-btn">
                      		{{ trans('admin.edit') }}
                      	</a>
                   ...
                   {!! Form::open([
	            	...
	            	{!! Form::submit(trans('admin.delete'), ['data-url' => $image->id, 'class' => 'btn btn-danger btn-sm padding-btn actionDelete']) !!}
	        	{!! Form::close() !!}
